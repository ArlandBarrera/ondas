...
%
% Temas de capitulos
\newcommand{\temas}{conceptos,matematica,interferencia,tipos,fenomenos,espectroElectromagnetico,sonido,aplicaciones}

% Subtemas especificos dentro de los capitulos
\newcommand{\subtemas}{transversal,longitudinal}
